  ...
  <div class="flex flex-col flex-1 h-full overflow-hidden">
    ...
    >
      <div class="max-w-full mx-auto space-y-7">
        ...
        >
          <div
            class="flex flex-col justify-center p-5 bg-white border border-gray-100 shadow-sm sm:p-6 rounded-2xl"
          >
            <div
              class="flex items-center justify-center w-12 h-12 mb-4 text-green-700 bg-green-100 rounded-xl"
            >
            ...
            <h3 class="text-4xl font-black text-gray-800">
              {jadwalList.length}
            </h3>
          ...
          >
            ...
            <h3 class="text-4xl font-black text-gray-800">
              {jadwalList.filter((j) => j.teamOnly === "Ya").length}
            </h3>
            <p class="mt-1 text-sm font-medium text-gray-500">Team Only</p>
          </div>

          <div
            class="flex flex-col justify-center p-5 bg-white border border-gray-100 shadow-sm sm:p-6 rounded-2xl sm:col-span-2 lg:col-span-1"
          >
            <div
              class="flex items-center justify-center w-12 h-12 mb-4 text-green-700 bg-green-100 rounded-xl"
            >
            ...
            <h3 class="text-4xl font-black text-gray-800">
              {jadwalList.filter((j) => j.teamOnly === "Tidak").length}
            </h3>
          ...
          {:else}
            ...
            <div class="hidden overflow-x-auto sm:block max-h-[400px]">
              <table class="w-full text-left border-collapse">
                <thead
                  class="sticky top-0 z-10 bg-gray-50 outline outline-1 outline-gray-100"
                >
                  <tr
                    class="text-sm text-gray-500 border-b border-gray-100 bg-gray-50"
                  >
                ...
                <tbody class="text-sm text-gray-700">
                  {#each jadwalList as jadwal}
                    <tr
                      class="transition-colors border-b border-gray-50 hover:bg-gray-50/50"
                    >
                      <!-- EVENT -->
            ...
            <div class="block space-y-4 sm:hidden p-4">
              {#each jadwalList as jadwal}
                <div
                  class="p-5 border border-gray-150 rounded-2xl bg-white shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden group"
                >
                  <!-- STATUS COLOR -->
                  <div
          ...
          {jadwal.status === 'Selesai'
                  ...
                  <div class="pl-2">
                    ...
                    <div class="flex items-start justify-between mb-3 gap-2">
                      <h4
                        class="text-base font-extrabold text-gray-900 leading-snug"
                      >
                        {jadwal.event}
                      </h4>

                      <span
                        class="inline-flex items-center px-2.5 py-1 text-xs font-bold rounded-full shrink-0
              {jadwal.status === 'Selesai'
                          ? 'bg-gray-100 text-gray-600'
                          : jadwal.status === 'Hari Ini'
                            ? 'bg-green-100 text-green-700'
                    ...
                    <!-- TANGGAL DAN JAM -->
                    <div
                      class="grid grid-cols-2 gap-3 py-3 border-t border-b border-gray-100 my-3 text-xs text-gray-600"
                    >
                      <!-- TANGGAL -->
                      <div class="space-y-1">
                        ...
                        <div
                          class="flex items-center gap-1.5 font-semibold text-gray-800"
                        >
                          <svg
                    ...
                    <div class="mb-3">
                      <span
                        class="text-xs text-gray-400 font-medium block mb-1"
                      >
                        Lokasi
                      </span>
                    ...
                    <div class="flex items-center justify-between mt-3">
                      ...
                      <div class="flex items-center gap-2">
                        ...
                        <span
                          class="inline-flex items-center px-2.5 py-0.5 text-xs font-bold rounded-full
                {jadwal.teamOnly === 'Ya'
