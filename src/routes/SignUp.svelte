      ...
      <form on:submit|preventDefault={handleSubmit} class="p-6 space-y-4">
        ...
        <div class="flex space-x-4">
          <div class="w-1/2 space-y-2">
            ...
            <input
              ...
              bind:value={username}
              required
              class="w-full px-4 py-3 border md:placeholder:text-sm border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0b5ba2] focus:border-[#0b5ba2] outline-none transition-colors"
            />
          </div>
          <div class="w-1/2 space-y-2">
        ...
        <div class="grid grid-cols-2 gap-3">
          <div class="space-y-2">
            <label
              for="game_id"
              class="block text-sm font-semibold text-gray-700">Game ID</label
            >
            <input
              id="game_id"
              type="text"
          ...
          <div class="space-y-2">
            <label
              for="server_id"
              class="block text-sm font-semibold text-gray-700">Server ID</label
            >
            <input
              id="server_id"
              type="text"
